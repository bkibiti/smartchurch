        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-secondary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="{{ route('sms.analyse') }}" method="POST">
                        @csrf
                        <div class="card-body">

                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Kiolezo</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Tuma Kwenda</label>
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="sendto" name="sendto">
                                        <option value="0" selected>--Chagua--</option>
                                        <option value="1">Kigango</option>
                                        <option value="2">Kanda</option>
                                        <option value="3">Jumuiya</option>
                                        <option value="4">Waumini</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="receiver" name="receiver[]" multiple="multiple" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group row">
                                        ...
                                        <font color="Blue"><label class="col-form-label" id="smsCount" name="smsCount"> 0</label></font>
                                        <input type="hidden" name="smsCount" id="smsCount2">
                                    </div>
                                    <div class="form-group row">
...
@push('page_scripts')
    ...
    <script>
        ...
        $("#sendto").change(function () {
            var id = this.value;
            $('#receiver').empty();
            $('#receiver').append($('<option>', {value: '0',text: '--Chagua--'}));
